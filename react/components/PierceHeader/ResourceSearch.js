...
const ResourceSearch = () => {
  ...
  const [dropdown, setDropDown] = useState({ selected: "RN" });
    ...
    <React.Fragment>
      <div className={styles.resContainer}>
        <div className={styles.resSearchBar}>
          <InputSearch
            placeholder="Enter Keyword, Document Name, Bulletin"
            value={state.value}
            size="regular"
...
{state.value?
      <div className={`${styles.resSearchResults} ${styles.resArrowTop}`}>
          {state.value &&
