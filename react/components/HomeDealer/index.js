...
const HomeDealer = () => {
  ...
  return (
    <>
      ...
      <div style={{border:"2px solid #f1f2f3" , borderRadius:"5px", margin:"12px"}}>
        <div className={styles.myAssests}>
          <p style={{color:"red",fontSize:"18px",fontWeight:"500"}}>Assets list</p>
          <a href="#">Manage my assets</a>
        </div>
